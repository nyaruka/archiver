-- Minimal subset of the temba schema - only the tables that archiver reads from or deletes from, and only the columns
-- it needs. Columns which are here should match their real definitions (name, type, nullability), so that changes in
-- temba which would break archiver are caught by the tests.
...
DROP TABLE IF EXISTS flows_flowstartcount CASCADE;
...
CREATE TABLE msgs_broadcast (
    ...
    base_language character varying(3) NOT NULL,
    created_on timestamp with time zone NOT NULL,
...
CREATE TABLE msgs_msg (
    ...
    folder character varying(1) NOT NULL,
...
CREATE TABLE msgs_msg_labels (
    id bigserial primary key,
    msg_id bigint NOT NULL REFERENCES msgs_msg(id),
    label_id bigint NOT NULL REFERENCES msgs_label(id)
);
...
CREATE TABLE flows_flowstartcount (
    id bigserial primary key,
    count bigint NOT NULL,
    is_squashed boolean NOT NULL,
    start_id integer NOT NULL REFERENCES flows_flowstart(id)
);
...
CREATE TABLE archives_archive (
    ...
    org_id integer NOT NULL REFERENCES orgs_org(id),
    rollup_id bigint NULL REFERENCES archives_archive(id)
);
...
INSERT INTO msgs_broadcast(id, org_id, translations, base_language, created_on, schedule_id, is_active) VALUES
(1, 2, '{"text": {"eng": "hello", "fre": "bonjour"}}', 'eng', '2017-08-12 22:11:59.890662+02:00', 1, TRUE),
(2, 2, '{"text": {"und": "hola"}}', 'und', '2017-08-12 22:11:59.890662+02:00', NULL, TRUE),
(3, 2, '{"text": {"und": "not purged"}}', 'und', '2017-08-12 19:11:59.890662+02:00', NULL, TRUE),
(4, 2, '{"text": {"und": "new"}}', 'und', '2019-08-12 19:11:59.890662+02:00', NULL, TRUE);

INSERT INTO msgs_msg(id, uuid, org_id, broadcast_id, text, created_on, sent_on, modified_on, direction, status, visibility, folder, msg_type, attachments, channel_id, contact_id, contact_urn_id, flow_id, ticket_uuid, msg_count, error_count, next_attempt) VALUES
(1, '019aa2bc-0ab3-7529-99fc-30002ff4f121', 2, NULL, 'message 1', '2017-08-12 21:11:59.890662+00', '2017-08-12 21:11:59.890662+00', '2017-08-12 21:11:59.890662+00', 'I', 'H', 'V', 'W', 'T', NULL, 2, 6, 7, NULL, NULL, 1, 0, '2017-08-12 21:11:59.890662+00'),
(2, '019aa2bc-7a63-7bfe-9b09-cee639cc4df2', 2, NULL, 'message 2', '2017-08-12 21:11:59.890662+00', '2017-08-12 21:11:59.890662+00', '2017-08-12 21:11:59.890662+00', 'I', 'H', 'D', 'D', 'T', NULL, 2, 6, 7, NULL, NULL, 1, 0, '2017-08-12 21:11:59.890662+00'),
(3, '019aa2bc-ca55-7b91-9e1f-4da42464d873', 2, NULL, 'message 3', '2017-08-12 21:11:59.890662+00', '2017-08-12 21:11:59.890662+00', '2017-08-12 21:11:59.890662+00', 'O', 'H', 'V', 'S', 'T', '{"image/png:https://foo.bar/image1.png", "image/png:https://foo.bar/image2.png"}', NULL, 6, 7, NULL, '019981a4-db0b-7237-8114-c140b0b8a482', 1, 0, '2017-08-12 21:11:59.890662+00'),
(4, '019aa2bd-0fe8-7f7c-9f36-95b372799f34', 2, NULL, 'message 4', '2017-08-13 21:11:59.890662+00', '2017-08-13 21:11:59.890662+00', '2017-08-13 21:11:59.890662+00', 'I', 'H', 'V', 'W', 'T', NULL, 2, 6, 7, NULL, NULL, 1, 0, '2017-08-13 21:11:59.890662+00'),
(5, '019aa2bd-4f1f-7397-8cdd-0fb608459855', 3, NULL, 'message 5', '2017-08-11 21:11:59.890662+02:00', '2017-08-11 21:11:59.890662+02:00', '2017-08-11 21:11:59.890662+02:00', 'I', 'H', 'V', 'W', 'T', NULL, 3, 7, 8, NULL, NULL, 1, 0, '2017-08-11 21:11:59.890662+02:00'),
(6, '019aa2bd-9c1c-747d-a1d6-1a2a0994b646', 2, 2, 'message 6', '2017-10-08 21:11:59.890662+00', '2017-10-08 21:11:59.890662+00', '2017-10-08 21:11:59.890662+00', 'I', 'H', 'V', 'W', 'T', NULL, 2, 6, 7, NULL, NULL, 1, 0, '2017-10-08 21:11:59.890662+00'),
(7, '019aa2be-0b49-70e7-bf7a-a3bdb43f48e7', 2, NULL, 'message 7', '2018-01-02 21:11:59.890662+00', '2018-01-02 21:11:59.890662+00', '2018-01-02 21:11:59.890662+00', 'I', 'H', 'X', 'D', 'T', NULL, 2, 6, 7, 2, NULL, 1, 0, '2018-01-02 21:11:59.890662+00'),
(9, '019aa2be-5106-71a2-82cd-be475fc97729', 2, NULL, 'message 9', '2017-08-12 21:11:59.890662+00', '2017-08-12 21:11:59.890662+00', '2017-08-12 21:11:59.890662+00', 'O', 'S', 'V', 'S', 'T', NULL, NULL, 6, NULL, 3, NULL, 1, 0, '2017-08-12 21:11:59.890662+00');

INSERT INTO msgs_label(id, uuid, org_id, name) VALUES
(1, '1d9e3188-b74b-4ae0-a166-0de31aedb34a', 2, 'Label 1'),
(2, 'c5a69101-8dc3-444f-8b0b-5ab816e46eec', 2, 'Label 2'),
(3, '9e13d3b6-1ffa-406e-b66b-5cebe6738488', 2, 'Label 3');
...
(
    ...
    2, TRUE, '019aa2c0-1000-7000-8000-000000000001', 6, 1,
    '{}',
    NULL, NULL,
...
(
    ...
    2, TRUE, '019aa2c0-1000-7000-8000-000000000002', 6, 1,
...
(
    ...
    3, TRUE, '019aa2c0-1000-7000-8000-000000000003', 7, 2,
...
(
    ...
    3, TRUE, '019aa2c0-1000-7000-8000-000000000004', 7, 2,
...
(
    ...
    3, TRUE, '019aa2c0-1000-7000-8000-000000000005', 7, 2,
    '{}',
    NULL, NULL,
...
(
    ...
    3, TRUE, '019aa2c0-1000-7000-8000-000000000006', 7, 2,
    '{}',
    NULL, NULL,
...
(
    ...
    2, TRUE, '019aa2c0-1000-7000-8000-000000000007', 7, 2,
    '{}',
    NULL, NULL,
...
(
    ...
    2, TRUE, '019aa2c0-1000-7000-8000-000000000008', 6, 1,
    '{"agree": {"category": "Strongly agree", "node_uuid": "a0434c54-3e26-4eb0-bafc-46cdeaf435ac", "name": "Do you agree?", "value": "A", "created_on": "2017-05-03T12:25:21.714339+00:00", "input": "A"}}',
